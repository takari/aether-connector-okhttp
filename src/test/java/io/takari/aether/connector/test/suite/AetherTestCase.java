...
import io.takari.aether.connector.test.suite.server.Behaviour;
import io.takari.aether.connector.test.suite.server.BehaviourServlet;
import io.takari.aether.connector.test.suite.server.Expect;
import io.takari.aether.connector.test.suite.server.Generate;
import io.takari.aether.connector.test.suite.server.Provide;
...
public abstract class AetherTestCase extends AetherBaseTestCase {
  ...
  protected void enableSsl() throws Exception {
    enableSsl = true;
    server.enableSsl(serverCertificates.sslContext());
  }
