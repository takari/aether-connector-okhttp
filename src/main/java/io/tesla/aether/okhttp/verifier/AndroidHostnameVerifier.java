package io.tesla.aether.okhttp.verifier;
 ...
 */
public final class AndroidHostnameVerifier implements HostnameVerifier {
  ...
  public boolean verify(String host, X509Certificate certificate) {
    return isNumeric(host) ? verifyIpAddress(host, certificate) : verifyHostName(host, certificate);
  }

  // Returns true if the string contains of three letters
  public boolean isNumeric(String host) {
